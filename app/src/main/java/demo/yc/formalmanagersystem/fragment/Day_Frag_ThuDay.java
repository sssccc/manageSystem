 ...
 */
public class Day_Frag_ThuDay extends DayBaseFrag {


    public Day_Frag_ThuDay() {
    ...
    {
        planList = ((TimeManageActivity)(getActivity())).sendPlanInfo(4);
//        planList.add(new Plan("课程设计1","javtyutyusdf",0,1,4,1,1));
//        planList.add(new Plan("课程设计2","java磕碜设计2",0,2,4,1,1));
//        planList.add(new Plan("课程设计3","java磕碜设计3",1,3,4,0,1));
//        planList.add(new Plan("课程设计4","java磕碜设计4",1,4,4,1,1));
//        planList.add(new Plan("没事做","无",2,5,4,0,0));
//        planList.add(new Plan("没事做","无",2,6,4,0,0));
    }
    ...
    public void onResume() {
        ...
        if(adapter != null) {
            setData();
            adapter.notifyDataSetChanged(); setCloseGroup(-1);
        }
        super.onResume();
