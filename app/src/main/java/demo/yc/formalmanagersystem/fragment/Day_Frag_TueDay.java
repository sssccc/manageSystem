 ...
 */
public class Day_Frag_TueDay extends DayBaseFrag {
    ...
    {
        planList = ((TimeManageActivity)(getActivity())).sendPlanInfo(2);
//        planList.add(new Plan("课程设计1","javtyutyusdf",0,1,2,1,1));
//        planList.add(new Plan("课程设计2","java磕碜设计2",0,2,2,1,1));
//        planList.add(new Plan("课程设计3","java磕碜设计3",1,3,2,0,1));
//        planList.add(new Plan("课程设计4","java磕碜设计4",1,4,2,1,1));
//        planList.add(new Plan("没事做","无",2,5,2,0,0));
//        planList.add(new Plan("没事做","无",2,6,2,0,0));
    }
