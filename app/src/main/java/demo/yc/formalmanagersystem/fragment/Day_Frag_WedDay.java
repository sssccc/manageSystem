 ...
 */
public class Day_Frag_WedDay extends DayBaseFrag {


    public Day_Frag_WedDay() {
    ...
    {
         planList = ((TimeManageActivity)(getActivity())).sendPlanInfo(3);
//        planList.add(new Plan("课程设计1","javtyutyusdf",0,1,3,1,1));
//        planList.add(new Plan("课程设计2","java磕碜设计2",0,2,3,1,1));
//        planList.add(new Plan("课程设计3","java磕碜设计3",1,3,3,0,1));
//        planList.add(new Plan("课程设计4","java磕碜设计4",1,4,3,1,1));
//        planList.add(new Plan("没事做","无",2,5,3,0,0));
//        planList.add(new Plan("没事做","无",2,6,3,0,0));
    }
