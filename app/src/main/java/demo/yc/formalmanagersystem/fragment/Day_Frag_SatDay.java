 ...
 */
public class Day_Frag_SatDay extends DayBaseFrag {


    ArrayList<Plan> planList = new ArrayList<>();

    public Day_Frag_SatDay() {
    ...
    {
        planList = ((TimeManageActivity)(getActivity())).sendPlanInfo(6);
//        planList.add(new Plan("课程设计1","javtyutyusdf",0,1,6,1,1));
//        planList.add(new Plan("课程设计2","java磕碜设计2",0,2,6,1,1));
//        planList.add(new Plan("课程设计3","java磕碜设计3",1,3,6,0,1));
//        planList.add(new Plan("课程设计4","java磕碜设计4",1,4,6,1,1));
//        planList.add(new Plan("没事做","无",2,5,6,0,0));
//        planList.add(new Plan("没事做","无",2,6,6,0,0));
    }
